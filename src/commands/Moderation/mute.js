...
module.exports = {
    ...
    .addStringOption(option => option.setName('reason').setDescription('The Reason Of Mute')),
    ...
    async execute (interaction, client) {
        ...
        if (user.permissions.has(PermissionFlagsBits.ModerateMembers)) return await interaction.reply({ embeds: [createErrorMessage('**I cannot mute this user!**')], ephemeral: true });
